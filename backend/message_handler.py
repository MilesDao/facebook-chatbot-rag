...
def handle_message(sender_id: str, user_message: str, user_id: str = None, openrouter_key: str = None, llm_model: str = "openai/gpt-oss-120b:free", system_prompt: str = None):
    """
